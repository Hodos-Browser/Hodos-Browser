...
**Status:** 🟢 B1 + B3 FIXED (2.6-E.fix2, verified live 2026-06-12). B2 reachability check pending. B4 deferred.
...
- **B2** — still open; needs the direct-fetch-reachability + IPC-bridge-origin check before rating.
