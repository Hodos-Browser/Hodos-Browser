...
**Status:** 🟢 B1 + B3 FIXED (2.6-E.fix2, verified live 2026-06-12). B2 reachability-checked → downgraded Low/Med (primary path safe; direct-fetch behind CORS+PNA; residual needs a co-test). B4 deferred.
