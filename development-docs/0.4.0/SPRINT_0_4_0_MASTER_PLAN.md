...
| **FEAT-B4** | Extensions — **RE-SCOPE** (curated first-party / CEF Chrome-runtime / defer) | `pending` | XL | `B4-extensions.md:1-48`; `BRAVE_FORK_FEASIBILITY.md:27-30,141-160`; only shipped bit = `CWIShimScript.h` `window.yours` lock | Original premise (host MetaMask) is **FALSE** on CEF. HARD-coupled to B2 (Chrome runtime forces Chrome toolbar). browser-extensions/ deep-dive docs UNTRUSTED. Shippable slice: EIP-6963 deconfliction. |
