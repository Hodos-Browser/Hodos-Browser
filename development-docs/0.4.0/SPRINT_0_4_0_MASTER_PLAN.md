...
10. **TAAL key** — rotate as part of 0.4.0, or accept (rotates monthly at build time)? → ✅ **DECIDED 2026-06-17:** keep the hardcoded-key model; drop in a fresh key at broadcast time until TAAL ships an env-var/alternative. No restructure.
