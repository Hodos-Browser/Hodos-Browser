...
- [~] **Farbling × adblock (Q2 T1–T8)** — **T5/T6/T8 GREEN on Windows 2026-08-10**, `q2_farbling_adblock_check.py`. **[ ] macOS owed. [ ] T1/T2/T3/T7 need real page loads. ⛔ T4 is KNOWN RED** (CreepJS worker column ≠ window column — *all* workers are unfarbled, P4e deferred; record as an accepted gap, do not chase).
