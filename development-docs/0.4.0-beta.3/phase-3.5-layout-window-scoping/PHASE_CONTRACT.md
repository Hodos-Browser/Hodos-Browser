...
**Status:** 🟢 **LANDED 2026-08-31** — fix shipped, 6 of 7 live rows GREEN with their REDs observed; `A4` SPLIT (§5.0.1). ⬜ Regression set still owed. · **Owner:** Matthew · **Platform:** Windows only
