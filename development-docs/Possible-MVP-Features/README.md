...
| [DOLPHIN_MILK_INTEGRATION.md](./DOLPHIN_MILK_INTEGRATION.md) | Bundle John Calhoun's open-source Dolphin Milk AI agent inside Hodos — single-install AI agent with a BSV wallet, no terminal, no API keys, no Claude account. Logged 2026-05-11; RESEARCH per priority matrix. |
