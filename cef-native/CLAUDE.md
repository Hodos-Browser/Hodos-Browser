...
| `CEF_VERSION` | `150.0.17+g94c1726+chromium-150.0.7871.187` | `150.0.38-7871.3571+gdfe5a23+chromium-150.0.7871.187` |
| `CHROME_VERSION` | 150.0.7871.187 | 150.0.7871.187 |
| Fork pin | `94c1726` (upstream 7871 head) | `dfe5a2343` — **carries C2's renderer-side [Sync] PULL**, which `94c1726` does not |
...
⚠️ **Windows is staged one fork pin behind.** `dfe5a2343` = `94c1726` plus the Hodos patch commits including `116b7fd8b` (C2 PUSH→PULL). Restage Windows before comparing farbling behaviour across platforms.
