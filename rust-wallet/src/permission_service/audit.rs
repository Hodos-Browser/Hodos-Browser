...
//!
//! Thin wrappers over `PermissionAuditRepository` that handle the sha256
//! hashing of bodies and the decision/CallKind/EngineReason serde-string
//! conversion. (Phase 2.6-H removed the shadow-log write helpers.)

use sha2::{Digest, Sha256};

use hodos_permission_engine::{CallKind, PermissionDecision};

use crate::database::permission_audit_repo::PermissionAuditEntry;
...
/// pair stored by `permission_audit_log`.
///
...
mod tests {
    use super::*;
    use hodos_permission_engine::{EngineReason, PermissionDecision, PromptType};
